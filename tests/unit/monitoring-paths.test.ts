...
describe('monitoring paths', () => {
  ...
  it('switches region or connection and keeps the section, defaulting the sub-page', () => {
    ...
    expect(switchConnectionPath('/accounts', target)).toBe('/c/def456abc123/us-east-1/overview/insights');
  });
  ...
  it('switches connection without leaving the account pages', () => {
    ...
    expect(switchConnectionPath('/accounts/new', target)).toBe('/c/def456abc123/us-east-1/overview/insights');
