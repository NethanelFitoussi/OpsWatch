...
describe('sectionLinks', () => {
  ...
  it('carries nothing when there is no range', () => {
    expect(sectionLinks(scope, 'overview', '')).toEqual([
      ...
      { subsection: 'health', href: '/c/abc123def456/eu-west-1/overview/health', comingSoon: true },
      { subsection: 'brief', href: '/c/abc123def456/eu-west-1/overview/brief', comingSoon: true },
