...
const SERVER_ONLY_MODULES = [
  ...
  'lib/store/history-settings.ts',
  'lib/history/provider.ts',
  'lib/history/opswatch-db.ts',
  'lib/history/settings.ts',
  'lib/collector/metrics-job.ts',
  'lib/history/estimate.ts',
  'lib/collector/metrics-job.ts',
  'lib/detect/key.ts',
  'lib/detect/score.ts',
  'lib/detect/types.ts',
  ...
  'lib/store/cloudflare.ts',
  'lib/collector/cloudflare-job.ts',
  ...
  'lib/db/backup.ts',
  'lib/ingest/decompress.ts',
  'lib/monitoring/subscriptions.ts',
  'lib/aws/forwarder-health.ts',
  'lib/aws/collection.ts',
  'lib/ai/log-query.ts',
