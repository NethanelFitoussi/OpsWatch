...
export default async function LogsPage({ params, searchParams }: Props) {
  ...
  return (
    // The picker is content, not a filter row: it carries its own search, its own ticks and the range the
    // editor reads, so it stays in the body next to the editor it feeds.
